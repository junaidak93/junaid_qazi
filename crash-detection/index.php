    ...
    <div class="body-wrapper">
        ...
        <div class="content">
            <section class="section-padding">
                <h2 class="title ">Crash Detection</h2>
                <div class="row">
                    <div class="col-lg-5">
                        <div class="detailimg">
                            <img class="" src="<?php echo $basesurl; ?>images/group778.png" alt="">
                            <i class="icon-Icon-ionic-ios-videocam"></i>
                        </div>
                    </div>
                    <div class="col-lg-7 align-self-center">
                        ...
                        <div class="row my-4">
                            <div class="col-lg-4">
                                ...
                                <p class="mb-0">09/2003</p>
                            </div>
                            <div class="col-lg-4">
                                <h6 class="mb-1">Lorem ipsum</h6>
                                <p class="mb-0">Inceptos phasellu</p>
                            </div>
                            <div class="col-lg-4">
                                <h6 class="mb-1">Lorem ipsum</h6>
                                <p class="mb-0">Inceptos phasellu</p>
                        ...
                        <a href="#" class="btn btn-primary w-50 mt-4">Save Details</a>
                    </div>
                </div>
            </section>
            <?php
